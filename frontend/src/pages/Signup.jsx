...
const Signup = () => {
  ...
  useEffect(() => {
    if (user) {
      if (!isLocalBackend && cart?.products.length > 0 && guestId) {
        dispatch(mergeCart({ guestId, user }));
      }

      navigate(isCheckoutRedirect ? "/checkout" : "/");
    }
  },[user,guestId,cart,navigate,isCheckoutRedirect,dispatch,isLocalBackend]);
      ...
      <div className="w-full flex md:w-1/2 flex-col justify-center items-center p-8 md:p-12 ">
        ...
        >
          <div className="flex justify-center mb-6">
            <h2 className="text-xl font-medium">ElitéMart</h2>
          </div>
          ...
          <p className="mb-6 text-center">
            Enter your name, username and password to Signup
          </p>
          {error ? (
